...
<div class="col-sm-6 col-md-6">
    ...
    <h3 class="spacer-bottom-sm">Table Porlet</h3>
        ...
        <div class="content">
            <table class="no-border">
                ...
                <tr>
                    ...
                    <th class="text-center primary-emphasis">Standard</th>
                ...
                <tr>
                    ...
                    <td class="text-center primary-emphasis"><i class="fa fa-check"></i></td>
                    <td class="text-center"><i class="fa fa-check"></i></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-center primary-emphasis">100 GB</td>
                    <td class="text-center">1 TB</td>
                </tr>
                <tr>
                    <td>SMS Credits</td>
                    <td class="text-center">0</td>
                    <td class="text-center primary-emphasis">50</td>
                    <td class="text-center">100</td>
                </tr>
                <tr>
                    <td>Free Support</td>
                    <td class="text-center"><i class="fa fa-times"></i></td>
                    <td class="text-center primary-emphasis"><i class="fa fa-times"></i></td>
                    <td class="text-center"><i class="fa fa-check"></i></td>
                </tr>
                <tr>
                    <td>Price</td>
                    <td class="text-center">$20 / Month</td>
                    <td class="text-center primary-emphasis-dark">$50 / Month</td>
                ...
                <div class="chat-wi">
                    <div class="chat-space nano nscroller">
                        <div class="chat-content content">
                            <div class="chat-conv">
                                <img alt="Avatar" class="c-avatar ttip" src="<?php echo $this->themePath;?>images/avatar1_50.jpg" data-toggle="tooltip" title="MiguelMich" />
                                <div class="c-bubble">
                            ...
                            <div class="chat-conv sent">
                                <img alt="Avatar" class="c-avatar ttip" src="<?php echo $this->themePath;?>images/avatar_50.jpg" data-toggle="tooltip" title="Adam" />
                                <div class="c-bubble">
            ...
            <div class="tab-pane cont" id="chat-2">
                <div class="chat-wi">
                    <div class="chat-space nano nscroller">
                        <div class="chat-content content">
                            <div class="chat-conv sent">
                                <img alt="Avatar" class="c-avatar ttip" src="<?php echo $this->themePath;?>images/avatar4_50.jpg" data-toggle="tooltip" title="Adam" />
                                <div class="c-bubble">
                ...
                <div class="chat-wi">
                    <div class="chat-space nano nscroller">
                        <div class="chat-content content">
                            ...
                            <div class="chat-conv sent">
                                <img alt="Avatar" class="c-avatar ttip" src="<?php echo $this->themePath;?>images/avatar3_50.jpg" data-toggle="tooltip" title="Lucy" />
                                <div class="c-bubble">
                                    <div class="msg">Hi, i need support with my iPhone?</div>
                                    <div><small>12:25 p.m.</small></div>
                                    <span></span>
