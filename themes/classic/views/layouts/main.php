...
<script src="<?php echo $this->themePath;?>js/jquery.select2/select2.min.js" type="text/javascript"></script>
<script src="<?php echo $this->themePath;?>js/skycons/skycons.js" type="text/javascript"></script>
<script src="<?php echo $this->themePath;?>js/bootstrap.slider/js/bootstrap-slider.js" type="text/javascript"></script>
<script src="<?php echo $this->themePath;?>js/intro.js/intro.js" type="text/javascript"></script>
