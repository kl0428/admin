...
class UEditor extends CInputWidget
{
    ...
    private $defaultToolbars = array(
        array(
            ...
            'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
            'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright',
            'imagecenter', '|', 'insertimage', 'insertvideo', 'map', 'gmap', 'insertframe', 'highlightcode', 'pagebreak', '|',
    ...
    {
        $this->UEDITOR_CONFIG['UEDITOR_HOME_URL'] = Yii::app()->baseUrl . '/ueditor/';
    ...
    protected function generateDefaultConfig()
    {
        ...
        $this->UEDITOR_CONFIG['imagePath'] = Yii::app()->params['UpYun']['visitUrl'];
