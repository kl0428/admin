 ...
 */
class BusinessPager extends CLinkPager {
	
	// Pager alignments.
	const ALIGNMENT_CENTER = 'centered';
	const ALIGNMENT_RIGHT = 'left';
...
//		}
		...
		$buttons[] = CHtml::tag('li', array('style'=>'margin-left:50px;'),'共'.$this->getPageCount().'页'. '前往第  '.CHtml::textField('pageNumber', $page+1, array(
				'style'=>'width:40px;text-align:center'
			)).'  页'.CHtml::button('确定',array('id'=>'gotoBtn','now_url'=>$URI,'class'=>'btn btn-xs btn-default')));
